...
const testimonials: Testimonial[] = [
  {
    ...
    role: 'Regular Client',
    content:
      "The most relaxing spa experience I've ever had. The aromatherapy massage was divine, and the staff's attention to detail is impeccable.",
    image:
  ...
  },
  {
    ...
    content:
      'Exceeded all my expectations. The facial treatment left my skin glowing, and the ambiance is truly luxurious. Will definitely return!',
    image:
  ...
  },
  {
    ...
    role: 'VIP Member',
    content:
      "I've been to many luxury spas, but Crazy Girls Salon stands out. Their attention to detail and personalized service is unmatched.",
    image:
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div className="flex items-center mb-6">
                ...
                />
                <div>
                  <h4 className="font-playfair text-lg text-navy">
                    {testimonial.name}
                  </h4>
              ...
              <p className="font-lora text-gray-700 italic">
                "{testimonial.content}"
              </p>
            </div>
          ))}
