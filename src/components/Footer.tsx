    ...
    <footer className="bg-navy text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          {/* About Section */}
          <div>
            <h3 className="font-playfair text-2xl mb-6">Crazy Girls Salon</h3>
            <p className="font-lora text-gray-300 mb-6">
              Experience luxury wellness and rejuvenation at its finest. Your
            ...
            <ul className="space-y-4 font-lora">
              <li className="flex items-center">
                ...
                <span className="text-gray-300">
                  123 Relaxation Ave, Wellness City
                </span>
              </li>
              <li className="flex items-center">
              ...
              <li className="flex items-center">
                ...
                <a
                  href="mailto:info@crazygirlssalon.com"
                  className="text-gray-300 hover:text-gold transition-colors duration-200"
                >
        ...
        <div className="mt-12 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-gray-300 font-lora text-sm">
              © {new Date().getFullYear()} Crazy Girls Salon. All rights reserved.
            </p>
          </div>
        </div>
      </div>
